public class BigIntegerTester {
  ...
  static void test_constructor(){
    ...
    try{
      BigInteger b = new BigInteger("-1337282919293829292");
      System.out.println("Constructor working for negatives without exceptions: true");
    }catch (Exception e){
      System.out.println("Exception thrown when inputting negative numbers");
    }
    try{
      BigInteger b = new BigInteger("0");
      System.out.println("Constructor working for zero: true");
    }catch (Exception e){
      System.out.println("Exception thrown when inputting zeros");
    }
  ...
  static void test_add() {
    ...
    try {
      ...
      BigInteger sum = b.add(b1);
      System.out.print("Adding Single Digits?: ");
      System.out.println(sum.equals("7"));
    } catch(Exception e) {
      System.out.println("Exception thrown when adding single Digits");
    }
    ...
    try {
      ...
      BigInteger sum = b.add(b1);
      System.out.print("Adding 99 and 1?: ");
    ...
    try {
      BigInteger b = new BigInteger("-10323");
      BigInteger b1 = new BigInteger("-13929400");
      BigInteger sum = b.add(b1);
      java.math.BigInteger a = new java.math.BigInteger("-10323").add(new java.math.BigInteger("-13929400"));
      System.out.println("***");
      System.out.println(sum.toString() + " is equal to " +  '\n' + a.toString() + "?" );
    } catch (Exception e) {
      System.out.println("Exception thrown when adding two negative numbers.");
    }

    try {
      BigInteger b = new BigInteger("1");
      BigInteger b1 = new BigInteger("-18392");
      BigInteger sum = b.add(b1);
      java.math.BigInteger a = new java.math.BigInteger("1").add(new java.math.BigInteger("-18392"));
      System.out.println("***");
      System.out.println(sum.toString() + " is equal to " +  '\n' + a.toString() + "?" );
    } catch (Exception e) {
      System.out.println("Exception thrown when adding a small positive to a large negative.");
    }
  ...
  static void test_subtract() {
    ...
    try {
      ...
      BigInteger b1 = new BigInteger("-4");
      BigInteger difference = b.subtract(b1);
      java.math.BigInteger a = new java.math.BigInteger("4").subtract(new java.math.BigInteger("-4"));
      System.out.println("***");
      System.out.println(difference.toString() + " is equal to " + '\n' + a.toString() + "?");
    } catch (Exception e) {
      System.out.println("Exception thrown when subtracting a positive from a negative complement.");
    }
    ...
    try {
      ...
      BigInteger difference = b.subtract(b1);
      java.math.BigInteger a = new java.math.BigInteger("4").subtract(new java.math.BigInteger("2"));
      System.out.println("***");
      System.out.println(difference.toString() + " is equal to " + '\n' + a.toString() + "?");
    } catch (Exception e) {
      System.out.println("Exception thrown when subtracting a single digit positive from a single digit positive.");
    }

    try {
      BigInteger b = new BigInteger("-10323");
      BigInteger b1 = new BigInteger("-139400");
      BigInteger difference = b.subtract(b1);
      java.math.BigInteger a = new java.math.BigInteger("-10323").subtract(new java.math.BigInteger("-139400"));
      System.out.println("***");
      System.out.println(difference.toString() + " is equal to " +  '\n' + a.toString() + "?" );
    } catch (Exception e) {
      System.out.println("Exception thrown when subtracting two negative numbers.");
    }
    ...
    try {
      ...
      BigInteger b1 = new BigInteger("-18392");
      BigInteger difference = b.subtract(b1);
      java.math.BigInteger a = new java.math.BigInteger("1").subtract(new java.math.BigInteger("-18392"));
      System.out.println("***");
      System.out.println(difference.toString() + " is equal to " +  '\n' + a.toString() + "?" );
    } catch (Exception e) {
      System.out.println("Exception thrown when subtracting a small positive to a large negative.");
    }
  ...
  static void test_multiply() {
    ...
    try {
      ...
      BigInteger b1 = new BigInteger("2");
      BigInteger product = b.multiply(b1);
      System.out.print("Simple Multplication?: ");
      System.out.println(product.equals(new BigInteger("80")));
    } catch (Exception e) {
      System.out.println("Exception thrown during simple multiplication.");
      e.printStackTrace();
    }
    ...
    try {
      ...
      BigInteger b1 = new BigInteger("-13929400");
      BigInteger product = b.multiply(b1);
      java.math.BigInteger a = new java.math.BigInteger("-10323").multiply(new java.math.BigInteger("-13929400"));
      System.out.println("***");
      System.out.println(product.toString() + " is equal to " +  '\n' + a.toString() + "?" );
    } catch (Exception e) {
      System.out.println("Exception thrown when multiplying two negative numbers.");
    }
    ...
    try {
      ...
      BigInteger b1 = new BigInteger("-18392");
      BigInteger product = b.multiply(b1);
      java.math.BigInteger a = new java.math.BigInteger("1").multiply(new java.math.BigInteger("-18392"));
      System.out.println("***");
      System.out.println(product.toString() + " is equal to " +  '\n' + a.toString() + "?" );
    } catch (Exception e) {
      System.out.println("Exception thrown when multiplying a small positive to a large negative.");
    }
  }
  ...
  static void test_divide() {
    ...
    try {
      ...
      System.out.println(quot.equals(new BigInteger("0")));
    } catch (Exception e) {
  ...
  static void test_valueOf() {
    ...
    try {
      ...
      BigInteger b = BigInteger.valueOf(l);
      System.out.print("Testing a long: ");
      System.out.println(b.equals(BigInteger.ONE));
    } catch ( Exception e ) {
      System.out.println("Exception thrown for testing valueOf() for one.");
    }
